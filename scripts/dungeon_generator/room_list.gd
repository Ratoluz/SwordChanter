...
func _assign_interiors() -> void:
	starter_room = load('res://scenes/dungeon_generator/rooms/chest/level_1/four_rocks.tscn')
	...
	chests_1.append(load('res://scenes/dungeon_generator/rooms/chest/level_1/four_rocks.tscn'))
